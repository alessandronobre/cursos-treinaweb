...
//    		
    		Link selfLink = linkTo(methodOn(FuncionarioControleApi.class).buscarPorId(id)).withSelfRel().withType("GET");
    		Link cargoLink = linkTo(methodOn(CargoControleApi.class).buscarPorId(cargoId)).withRel("cargo").withType("GET");
//    		
	...
	public void addLinks(CollectionModel<EntityModel<Funcionario>> resources) {
		Link selfLink = linkTo(methodOn(FuncionarioControleApi.class).buscarTodos(null)).withSelfRel().withType("GET");
