...
public class GerenciadorDeExecocoesApi extends ResponseEntityExceptionHandler {
    
    @ExceptionHandler(EntityNotFoundException.class)
    public ResponseEntity<ApiErro> hendleEntityNotFoundException(EntityNotFoundException exception) {
