...
public class ClienteAssembler implements SimpleRepresentationModelAssembler<Cliente>{
	...
	public void addLinks(EntityModel<Cliente> resource) {
    		...
    		Link selfLink = linkTo(methodOn(ClienteControleApi.class).buscarPorId(id)).withSelfRel().withType("GET");
    		Link projetosLink = linkTo(methodOn(ClienteControleApi.class).buscarProjetos(id)).withRel("projetos").withType("GET");
	...
	public void addLinks(CollectionModel<EntityModel<Cliente>> resources) {
		Link selfLink = linkTo(methodOn(ClienteControleApi.class).buscarTodos(null)).withSelfRel().withType("GET");
